...
const FooterHome = () => {
    ...
    return (
        <>
            <div className="hidden md:flex justify-between bg-[#484848] mx-auto w-auto py-5">
                <div className="flex justify-between  flex-col md:py-40  w-4/12">
    ...
    "
          ...
          <img src={bonetskogo} alt="" /> */}
                    ...
                    <div
                        className="md:hidden flex font-jost flex-col justify-between bg-[#484848] text-white  mx-auto px-3 w-auto py-5">
            ...
            {/*  */}
            <div
                className="hidden md:flex font-jost justify-between bg-[#484848] text-white  mx-auto px-9   w-auto py-5">
