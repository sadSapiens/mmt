...
const Cards = () => {
  return (
    <div className="py-7  flex justify-center md:w-[80%] w-[40%]">
      <div className=" border border-black  md:flex justify-center flex-col items-center object-center content-center place-items-center">
        <div className=" flex">
