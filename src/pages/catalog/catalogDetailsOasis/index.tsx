...
const CatalogDetailsOasis = () => {
    ...
    return (
        <div>
            {selectedProduct ? (
                <>
                    <div className="mx-auto md:px-10 px-3 w-auto py-5 flex-wrap">
                        <div/>
                  ...
                  <span className=" text-2xl font-medium font-jost text-black">
                    {selectedProduct.full_name}
                                ...
                                <div className="flex flex-col">
                                    <div className="overflow-x-auto scroll-photo sm:-mx-4 lg:-mx-4 flex-wrap ">
                                        <div className="py-2 inline-block min-w-full sm:px-6 lg:px-8 flex-wrap ">
                        ...
                        >
                            <div
                                ...
                                <div>
                                    ...
                                    <div
                                        className="flex justify-start flex-wrap break-all flex-col md:flex-row md:justify-center md:items-center px-1 ">
