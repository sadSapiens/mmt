    ...
    return (
        ...
        "
                        ...
                        ? subcategories.map((item: any, i: number) => (
                            ...
                            >
                                <div className="flex justify-center items-center gap-2 flex-row">
                                    <button
                                        className="rounded-full ... border !border-black md:w-[10%] w-auto h-8 px-4 text-black">
                                        {item.name}
                                    </button>
                                </div>
                            </Link>
            ...
            <div className="md:flex pt-10 font-jost">
                ...
                >
                    <div className="w-1/8">
                        ...
                        <div
                            className="accordion__content overflow-y-auto overflow-x-clip  flex justify-start items-center">
          ...
          "
                ...
                <div
                    className="flex  justify-between md:w-9/12 w-[100%] items-center align-middle text-center self-start flex-col">
