      ...
      <>
        {about ? (
          <div className=" text-white">
            ...
            {about.director && (
              <div className="flex text-black  mx-auto md:px-9 px-4  w-auto pt-28 flex-col md:flex-row mt-36 md:mt-5">
                <div className="md:hidden flex flex-col">
                  <span className="font-semibold ">
                    «Мы - команда креативных людей, влюбленных в свое дело,
                    более 9 лет занимаемся брендингом и заслужили доверие
                    лидеров рынка.
                    <p className="py-3">
                      {" "}
                      Свежий взгляд и неординарный подход к созданию бизнес
                      мерча – наше кредо»
                    </p>
                  </span>
                </div>

                <div className=" md:w-3/12 w-auto flex md:justify-start items-center flex-col md:mt-14">
            ...
            <div className=" hidden md:flex flex-col md:flex-row bg-[#343434]  mx-auto px-9   w-auto py-5">
              ...
              <div>
                <span className="font-normal	 text-sm">
                  ...
                  волну, чтобы аудитория отвечала взаимностью, впуская ваш бренд
