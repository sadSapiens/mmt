        ...
        <>
            {about ? (
                <div className=" text-white ">
                    ...
                    <div
                        className="  mx-auto px-9  bg-[#343434] w-auto py-10  md:flex md:justify-between flex flex-col ">
            ...
            <p className="py-2 ">
              ...
              вам оптимальный вариант.
                ...
                <span className="font-semibold ">
                  ...
                  9 лет занимаемся брендингом и заслужили доверие лидеров рынка.
                  <p className="py-3">
                    {" "}
                      Свежий взгляд и неординарный подход к созданию бизнес мерча
                    – наше кредо»
                  </p>
                </span>
                            </div>
                ...
                <span className="font-bold hidden md:flex">
                  {about.director.slogan}
                    ...
                    {/*  */}
                    <div
                        className=" hidden   md:flex-row flex-col text-black justify-around mx-auto  px-0   w-auto md:py-5">
                  ...
                  <span className="font-normal text-sm flex justify-center items-center text-center px-4">
                    ...
                    управлению, чтобы потребители вашего бренда стали еще ближе
                    к вам»
                  </span>
                                </div>
                            </div>
              ...
              <span className="font-normal	 text-sm">
                «От идеи до воплощения корпоративных подарков – волшебный
                творческий процесс, требующий четкой организации. Время – самое
                бесценное в нашей жизни. Мы стремимся к эффективному управлению,
                чтобы потребители вашего бренда стали еще ближе к вам»
              </span>
                        </div>
                        <div>
              <span className="font-normal	 text-sm">
                «Наша цель - помочь компаниям заявить о себе эффективно
                используя бизнес сувениры. Мы постоянно держим руку на пульсе
                рекламного мира, о всех трендах, едва только появившихся, мы
                сразу информируем своих клиентов, чтобы дать им конкурентное
              ...
              <span className="font-normal	 text-sm">
                ...
                взаимодействии. Моя задача – настроить эту связь на нужную
                волну, чтобы аудитория отвечала взаимностью, впуская ваш бренд в
