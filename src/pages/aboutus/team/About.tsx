      ...
      <div className="  mx-auto px-9  bg-[#343434] w-auto py-5 ">
        ...
        <div className="w-8/12 py-10">
          <p>
            ...
            волшебники. Наша работа – создавать красоту, хорошее настроение и
            классные подарки! Чем мы занимаемся? Мы производим корпоративную,
            ...
            работаем напрямую с фабриками-производителями рекламной продукции в
            Китае, с ассортиментом ведущих европейских каталогов, а также имеем
        ...
        <div className="absolute w-3/12 top-1/3 right-16">
          <img src={about} alt="" />
        </div>
      </div>
