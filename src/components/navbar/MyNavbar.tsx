                                    ...
                                    <div className="flex justify-end items-end">
                                        {
                                            ...
                                            order?.items.length > 0 ? (
                                                ...
                                                <>
                          <span
                              className=" absolute left-2 font-normal px-0.5 h-3 w-3 flex justify-center items-center object-contain py-1 text-sm rounded-full leading-none text-center whitespace-nowrap align-baseline bg-red-600 text-white  ">
                            {order?.items.length}
                          </span>
                                                </>
                                            ) : null
